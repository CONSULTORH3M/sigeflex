...
def gerar_recibo_padrao():
    try:
        ...
        # Mensagem de sucesso = SE QUISER VIR A MENSAGEM TEM QUE DESCOMENTAR
        #messagebox.showinfo("Sucesso", f"Recibo Gerado com Sucesso! Arquivo Salvo como {nome_arquivo}")
...
def chamar_tela_insercao():
    ...
    #########################################################################################
    # BOTOES QUE FICAM DENTRO DA JANELA ROOT do INSERIR INFORMAÇÕES MANUALMENTE NO RECIBO RÁPIDO   

    # Botao para chamar a FUNÇÃO DE GERAR RECIBO
